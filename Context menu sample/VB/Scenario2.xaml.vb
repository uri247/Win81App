...
Partial Public NotInheritable Class Scenario2
    ...
    Private Function GetTextboxSelectionRect(ByVal textbox As TextBox) As Rect
        Dim rectFirst, rectLast As Rect
    ...
    Private Async Sub ReadOnlyTextBox_ContextMenuOpening(ByVal sender As Object, ByVal e As ContextMenuEventArgs)
        e.Handled = True
        ...
        If textbox.SelectionLength > 0 Then
            ...
            If chosenCommand IsNot Nothing Then
                Select Case CInt(chosenCommand.Id)
                    Case 1
                        Dim selectedText As String = CType(sender, TextBox).SelectedText
