...
namespace PdfShowcase
{
	...
	protected:
		...
		// Event Handler for Sharing items
		void EventHandlerShareItems(_In_ Windows::ApplicationModel::DataTransfer::DataTransferManager^ sender, _In_ Windows::ApplicationModel::DataTransfer::DataRequestedEventArgs^ e);
    ...
    private:
		PdfDataSource^							pdfPageDataSourceZoomedInView;
		PdfDataSource^							pdfPageDataSourceZoomedOutView;
