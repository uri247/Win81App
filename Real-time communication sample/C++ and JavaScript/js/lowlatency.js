...
(function () {
    ...
    var LowLatencyModelType = WinJS.Class.define(function () {      
        ...
        this._previewPosterElement = document.getElementById("webcamPreviewPoster");
        ...
        initialize: function () {
            ...
            SimpleCommunication.captureMgr.lockAsync().then(function (device) {
                ...
                SdkSample.unlockScenarioChange();
        ...
        _cleanup: function () {
            ...
            if (this._previewVideoElement && !this._previewVideoElement.paused) {
                this._previewVideoElement.src = ""; 
            }
        ...
        _previewStarted: function () {
            this._previewPosterElement.className = "item";
        ...
        _reset: function () {
            ...
            this._previewVideoElement.className = "item";
            this._playbackVideoElement.className = "";
            this._realTimePlaybackVideoElement.className = "item";
            this._previewPosterElement.className = "item shown";
            ...
            if (this._currentState === scenarioOneStates.end) {
                ...
                this._previewPosterElement.className = "";
            }
        },
        ...
        actionTransitionFunctions: {
            ...
            waiting: {
                ...
                /// <returns type="String">The next state</returns>
                    if (this._previousState === scenarioOneStates.initializing) {
            ...
            previewing: {
                ...
                /// <param name="this" type="SimpleCommunication.LowLatency.ModelType"/>
                /// <returns type="String">The next state</returns>
                    this._previewVideoElement.pause();
                    this._previousState = this._currentState;
                    this._currentState = scenarioOneStates.waiting;
                    this._previewStoped();
                },
...
(function () {
    ...
    var page = WinJS.UI.Pages.define("/html/lowlatency.html", {
