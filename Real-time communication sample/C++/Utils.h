...
namespace SimpleCommunication
{
    ...
    delegate void IncomingconnectioneventHandler(Microsoft::Samples::SimpleCommunication::StspMediaSink^ sender, Microsoft::Samples::SimpleCommunication::IncomingConnectionEventArgs^ args);
    ...
    private:
        ...
        // Custom media sink
        Microsoft::Samples::SimpleCommunication::StspMediaSink^ _mediaSink;
    ...
    internal:
        ...
        void OnIncomingConnection(Microsoft::Samples::SimpleCommunication::StspMediaSink^ sender, Microsoft::Samples::SimpleCommunication::IncomingConnectionEventArgs^ args)
        {
            ...
            Incomingconnectionevent(sender, args);
        }
