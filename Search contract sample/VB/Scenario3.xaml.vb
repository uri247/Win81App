...
Partial Public NotInheritable Class Scenario3
    ...
    Private Sub OnSearchPaneSuggestionsRequested(ByVal sender As SearchPane, ByVal e As SearchPaneSuggestionsRequestedEventArgs)
        ...
        Else
            ...
            Dim linguisticDetails = e.LinguisticDetails
            For Each alternative As String In linguisticDetails.QueryTextAlternatives
                For Each suggestion As String In suggestionList
                    If suggestion.StartsWith(alternative, StringComparison.CurrentCultureIgnoreCase) Then
