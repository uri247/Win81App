...
namespace MicrosoftAccount
{
    ...
    /// </summary>
    public sealed partial class JwtToken : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private async void GetUserInfo()
        {
            ...
            // in production, you should use https://jsonwebtokensample.com instead of http://localhost
            Uri uri = new Uri("http://localhost/JsonWebTokenSample/Default.aspx?access_token=" + this._Token);
