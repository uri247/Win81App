...
namespace MicrosoftAccount
{
    ...
    /// </summary>
    public sealed partial class DelegationToken : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        public string AccessToken
        {
            ...
            private set
            {
                if (_accessToken != value)
                {
                    ...
                    if (value != null)
                    {
                        UserPicture.Source = new BitmapImage(new Uri("https://apis.live.net/v5.0/me/picture?access_token=" + value));
        ...
        {
            var uri = new Uri("https://apis.live.net/v5.0/me?access_token=" + token);
