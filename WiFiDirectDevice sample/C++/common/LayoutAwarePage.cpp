...
using namespace WiFiDirectDeviceCPP::Common;
...
/// </summary>
/// <remarks>
/// The default value of false indicates that the visual state is identical to the layout,
...
/// <seealso cref="InvalidateVisualState"/>
Platform::String^ LayoutAwarePage::DetermineVisualState(double width)
{
