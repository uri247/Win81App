...
{
    InitializeComponent();
    this->Suspending += ref new SuspendingEventHandler(this, &WiFiDirectDeviceCPP::App::OnSuspending);
}
...
{
    TypeName pageType = { "WiFiDirectDeviceCPP.MainPage", TypeKind::Custom };
