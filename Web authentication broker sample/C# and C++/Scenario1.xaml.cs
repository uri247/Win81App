...
namespace WebAuthentication
{
    ...
    public sealed partial class Scenario1 : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private void DebugPrint(String Trace)
        {
            ...
            TextBox FacebookDebugArea = rootPage.FindName("FacebookDebugArea") as TextBox;
        ...
        private void OutputToken(String TokenUri)
        {
            ...
            TextBox FacebookReturnedToken = rootPage.FindName("FacebookReturnedToken") as TextBox;
