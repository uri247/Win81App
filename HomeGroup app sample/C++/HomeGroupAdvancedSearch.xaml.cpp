...
//
// HomeGroupAdvancedSearch.xaml.cpp
// Implementation of the HomeGroupAdvancedSearch class
//
...
void SDKSample::HomeGroup::HomeGroupAdvancedSearch::Default_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
