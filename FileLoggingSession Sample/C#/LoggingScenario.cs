...
namespace FileLoggingSession
{
    ...
    /// sample code. 
    /// </summary>
    class LoggingScenario : IDisposable
    {
        ...
        public void StartLogging()
        {
            ...
            if (session == null)
            {
                session = new Windows.Foundation.Diagnostics.FileLoggingSession(DEFAULT_SESSION_NAME);
        ...
        public void ResumeLoggingIfApplicable()
        {
            ...
            if (ApplicationData.Current.LocalSettings.Values.TryGetValue("LogFileGeneratedBeforeSuspend", out LogFileGeneratedBeforeSuspendObject) &&
        ...
        /// </summary>
        public const string OUR_SAMPLE_APP_LOG_FILE_FOLDER_NAME = "OurAppLogFiles";
        ...
        /// </summary>
        private Windows.Foundation.Diagnostics.FileLoggingSession session;
