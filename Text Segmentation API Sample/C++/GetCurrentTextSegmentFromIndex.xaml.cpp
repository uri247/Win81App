...
//
// GetCurrentTextSegmentFromIndex.xaml.cpp
// Implementation of the GetCurrentTextSegmentFromIndex class
//

#include "pch.h"
#include "GetCurrentTextSegmentFromIndex.xaml.h"
...
/// </summary>
GetCurrentTextSegmentFromIndex::GetCurrentTextSegmentFromIndex()
{
    InitializeComponent();
}
...
void TextSegmentation::GetCurrentTextSegmentFromIndex::WordSegmentButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
/// <param name="sender">The object that raised the event.</param>
/// <param name="e">Event data that describes the click action on the button.</param>
void TextSegmentation::GetCurrentTextSegmentFromIndex::SelectionSegmentButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    Button^ b = dynamic_cast<Button^>(sender);
    if (b != nullptr)
    {
