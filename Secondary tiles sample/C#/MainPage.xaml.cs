...
namespace SDKTemplate
{
    ...
    public sealed partial class MainPage : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private void InvalidateLayout()
        {
            ...
            VisualStateManager.GoToState((Control)InputSection, DetermineVisualState(this.ActualWidth), false);
            VisualStateManager.GoToState((Control)OutputSection, DetermineVisualState(this.ActualWidth), false);
        }
        ...
        public void LoadScenario(Type scenarioClass)
        {
            ...
            if (scenarioClass == typeof(SecondaryTiles.PinFromAppbar))
            {
            ...
            hiddenPage = HiddenFrame.Content as Page;
