...
Platform::Array<Scenario>^ MainPage::scenariosInner = ref new Platform::Array<Scenario>
{
    ...
    { "Pin Tile Alternate Visual Elements", "SecondaryTiles.PinTileAlternateVisualElements" },
    { "Pin Tile Alternate Visual Elements Async", "SecondaryTiles.PinTileAlternateVisualElementsAsync" }
};
