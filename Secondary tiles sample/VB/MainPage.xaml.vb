...
Namespace Global.SDKTemplate
    ...
    Public NotInheritable Partial Class MainPage
        ...
        Private Sub InvalidateLayout()
            ...
            VisualStateManager.GoToState(CType(InputSection, Control), DetermineVisualState(Me.ActualWidth), False)
            VisualStateManager.GoToState(CType(OutputSection, Control), DetermineVisualState(Me.ActualWidth), False)
        End Sub
        ...
        Public Sub LoadScenario(ByVal scenarioClass As Type)
            Dim hiddenPage As Page = Nothing
            If scenarioClass Is GetType(SecondaryTiles.PinFromAppbar) Then
                HiddenFrame.Navigate(scenarioClass)
            ...
            hiddenPage = TryCast(HiddenFrame.Content, Page)
