...
''' </summary>
Partial Public NotInheritable Class PinTileAlternateVisualElementsAsync
    ...
    Private Sub VisualElementsRequestedHandler(ByVal sender As Object, ByVal args As VisualElementsRequestedEventArgs)
        ...
        Dim deferral As VisualElementsRequestDeferral = args.Request.GetDeferral()
        ...
        ThreadPoolTimer.CreateTimer(Async Sub(timer)
                                        ...
                                        Await Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, Sub()
                                                                                                                     Me.SetAlternativeElements(args)
                                                                                                                     deferral.Complete()
                                                                                                                 End Sub)
                                    End Sub, TimeSpan.FromSeconds(3))
    End Sub

    Private Sub SetAlternativeElements(ByVal args As VisualElementsRequestedEventArgs)
        ...
        If args.Request.Deadline > Date.Now Then
