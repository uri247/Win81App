...
using namespace SDKSample::MessageDialogSample;
...
void SDKSample::MessageDialogSample::DefaultCloseCommand::DefaultCloseCommandButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
