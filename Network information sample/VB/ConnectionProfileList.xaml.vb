...
''' </summary>
Partial Public NotInheritable Class ConnectionProfileList
    ...
    ''' <param name="e"></param>
    Private Sub ConnectionProfileList_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        Dim connectionProfileList As String = String.Empty
        Try
            Dim ConnectionProfiles = NetworkInformation.GetConnectionProfiles()
