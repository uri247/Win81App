...
ShowOptionsUI::ShowOptionsUI()
{
    ...
    systemMediaControls->PropertyChanged += ref new TypedEventHandler<SystemMediaTransportControls^, SystemMediaTransportControlsPropertyChangedEventArgs^>(this, &ShowOptionsUI::SystemMediaControls_PropertyChanged);
}
...
void SDKSample::CameraOptions::ShowOptionsUI::SystemMediaControls_PropertyChanged(SystemMediaTransportControls^ sender, SystemMediaTransportControlsPropertyChangedEventArgs^ e)
{
    switch (e->Property)
    {
    case SystemMediaTransportControlsProperty::SoundLevel:
        ...
        dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler([this, sender] ()
        {
