...
void ::SDKSample::Compression::Scenario2::DoScenario(CompressAlgorithm Algorithm)
{
    Progress->Text = "";
...
void ::SDKSample::Compression::Scenario2::Default_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void ::SDKSample::Compression::Scenario2::Xpress_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    Button^ b = safe_cast<Button^>(sender);
...
void ::SDKSample::Compression::Scenario2::XpressHuff_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    Button^ b = safe_cast<Button^>(sender);
...
void ::SDKSample::Compression::Scenario2::Mszip_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    Button^ b = safe_cast<Button^>(sender);
...
void ::SDKSample::Compression::Scenario2::Lzms_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    Button^ b = safe_cast<Button^>(sender);
