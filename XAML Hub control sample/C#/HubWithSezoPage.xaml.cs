...
namespace HubControl
{
    ...
    /// </summary>
    public sealed partial class HubWithSezoPage : Page
    {
        List<string> images;
        List<string> states;
        List<Widget> widgets;
        ...
        public HubWithSezoPage()
        {
            ...
            SampleHub.Loaded += SampleHub_Loaded;
        }

        void SampleHub_Loaded(object sender, RoutedEventArgs e)
        {
            foreach (HubSection section in SampleHub.Sections)
            {
