...
namespace HubControl
{
    ...
    /// </summary>
    public sealed partial class VerticalHubPage : Page
    {
        List<string> images;
        List<string> states;
        List<Widget> widgets;
        ...
        void VerticalHubPage_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            {
                SampleHub.Orientation = Orientation.Vertical;
                ScrollViewer.SetVerticalScrollMode(SampleHub, ScrollMode.Enabled);
                ScrollViewer.SetHorizontalScrollMode(SampleHub, ScrollMode.Disabled);
                ScrollViewer.SetVerticalScrollBarVisibility(SampleHub, ScrollBarVisibility.Auto);
                ScrollViewer.SetHorizontalScrollBarVisibility(SampleHub, ScrollBarVisibility.Disabled);
            ...
            {
                SampleHub.Orientation = Orientation.Horizontal;
                ScrollViewer.SetVerticalScrollMode(SampleHub, ScrollMode.Disabled);
                ScrollViewer.SetHorizontalScrollMode(SampleHub, ScrollMode.Enabled);
                ScrollViewer.SetVerticalScrollBarVisibility(SampleHub, ScrollBarVisibility.Disabled);
                ScrollViewer.SetHorizontalScrollBarVisibility(SampleHub, ScrollBarVisibility.Auto);
