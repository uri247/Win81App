...
void InAppPurchase::TestProduct1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void InAppPurchase::TestProduct2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    auto licenseInformation = CurrentAppSimulator::LicenseInformation;
