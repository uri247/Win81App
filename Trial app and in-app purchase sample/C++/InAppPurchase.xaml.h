...
namespace SDKSample
{
    namespace StoreSample
    {
        ...
        private:
            ...
            void TestProduct1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
            void BuyProduct1Button_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
            void TestProduct2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
