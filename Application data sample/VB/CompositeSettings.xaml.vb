...
Partial Public NotInheritable Class CompositeSettings
    ...
    Private Const settingName As String = "exampleCompositeSetting"
    Private Const settingName1 As String = "one"
    Private Const settingName2 As String = "hello"
    ...
    Private Sub WriteCompositeSetting_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
    ...
    Private Sub DeleteCompositeSetting_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
