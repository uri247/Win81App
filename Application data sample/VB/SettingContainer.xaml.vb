...
Partial Public NotInheritable Class SettingContainer
    ...
    Private Const containerName As String = "exampleContainer"
    ...
    Private Sub CreateContainer_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
    ...
    Private Sub DeleteContainer_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
