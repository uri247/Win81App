...
using namespace SDKSample::SemanticTextQuery;
...
{
    { "Find Scenario",                            "SDKSample.SemanticTextQuery.Scenario1" }, 
    { "FindInProperty Scenario",                  "SDKSample.SemanticTextQuery.Scenario2" },
    { "GetMatchingPropertiesWithRanges Scenario", "SDKSample.SemanticTextQuery.Scenario3" }
}; 

void SDKSample::SemanticTextQuery::HighlightRanges(TextBlock^ tb,  String^ TextContent, IVectorView<TextSegment>^ ranges)
{
