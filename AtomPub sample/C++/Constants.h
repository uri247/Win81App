...
namespace SDKSample
{
    ...
    public:
        ...
        bool HandleException(Platform::String^ message, int error, Windows::UI::Xaml::Controls::TextBox^ outputField)
        {
            SyndicationErrorStatus syndicationError = SyndicationError::GetStatus(error);
            ...
            {
                Windows::Web::WebErrorStatus webError = Windows::Web::WebError::GetStatus(error);
    ...
    public:
        ...
        static Platform::String^ Join(Platform::String^ separator, Windows::Foundation::Collections::IVectorView<Platform::String^>^ iv) 
        {
            ...
            return ref new Platform::String(ret.data(), static_cast<unsigned int>(ret.size()));
        }
    };
