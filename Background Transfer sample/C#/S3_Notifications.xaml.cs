...
namespace BackgroundTransfer
{
    ...
    public sealed partial class S3_Notifications : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private static readonly Uri baseUri = new Uri("http://localhost/BackgroundTransferSample/notifications.aspx");
