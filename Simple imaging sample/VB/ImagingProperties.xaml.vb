...
Partial Public NotInheritable Class ImagingProperties
    ...
    Private Const E_INVALIDARG As Integer = CInt(&H80070057)
    ...
    Private Function GetImagePropertiesForDisplay(ByVal retrievedProps As IDictionary(Of String, Object)) As IDictionary(Of String, String)
        ...
        Dim latRefText, longRefText, latDegText, latMinText, latSecText, longDegText, longMinText, longSecText As String
        ...
        Else
            longSecText = ""
            longMinText = longSecText
            longDegText = longMinText
            latSecText = longDegText
            latMinText = latSecText
            latDegText = latMinText
            longRefText = latDegText
            latRefText = longRefText
        End If
    ...
    Private Async Function DisplayImageUIAsync(ByVal file As StorageFile, ByVal propertyText As IDictionary(Of String, String)) As Task
    ...
    ''' </summary>
    Private Async Sub Apply_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        If KeywordsTextbox.Text.Length > 0 Then
            Dim keywordsArray() As String = KeywordsTextbox.Text.Split(CChar(vbLf))
            m_imageProperties.Keywords.Clear()

            For i As Integer = 0 To keywordsArray.Length - 1
        ...
        Dim latitude(2) As Double
        Dim longitude(2) As Double
        Dim latitudeRef As String = String.Empty
        Dim longitudeRef As String = String.Empty
        ...
        Catch e1 As Exception ' Treat any exception as invalid GPS data.
            gpsWriteFailed = True
        End Try
        ...
        Catch err As Exception
            Select Case err.HResult
                Case E_INVALIDARG
                    ...
                    rootPage.NotifyUser("Error: A property value is invalid, or the file format does " & "not support one or more requested properties.", NotifyType.ErrorMessage)
