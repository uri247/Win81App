...
namespace Clipboard
{
    public sealed partial class OtherScenarios : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        {
            RegisterClipboardContentChange.IsChecked = OtherScenarios.registerContentChanged;
        }
        ...
        void Init()
        {
            ...
            RegisterClipboardContentChange.Click += new RoutedEventHandler(RegisterClipboardContentChanged_Click);
        ...
        {
            if (OtherScenarios.registerContentChanged != RegisterClipboardContentChange.IsChecked.Value)
            {
                this.ClearOutput();
                OtherScenarios.registerContentChanged = RegisterClipboardContentChange.IsChecked.Value;
