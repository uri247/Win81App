...
void Scenario4::OnSetPositionToHere(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    Window::Current->CoreWindow->PointerCursor = ref new Windows::UI::Core::CoreCursor(CoreCursorType::Wait, 0);
    ...
    geopositionTask.then([this, oldCursor](task<Geoposition^> getPosTask)
    {
        try
        {
