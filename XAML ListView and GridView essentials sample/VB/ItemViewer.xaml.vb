...
Partial Public NotInheritable Class ItemViewer
    ...
    Public Sub ShowPlaceholder(ByVal item As Expression.Blend.SampleData.SampleDataSource.Item)
        _item = item
    ...
    Private _item As Expression.Blend.SampleData.SampleDataSource.Item
End Class
