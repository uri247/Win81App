...
{
    public sealed partial class CalibrationBar : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private const double BELOW_768_LAYOUT_WIDTH = 768.0;
        ...
        private void InvalidateLayout()
        {
            ...
            if (CalibrationGrid.Width < BELOW_768_LAYOUT_WIDTH)
            {
