...
//
// S1_ChatClient.xaml.cpp
// Implementation of the S1_ChatClient class
//

#include "pch.h"
#include "S1_ChatClient.xaml.h"
...
S1_ChatClient::S1_ChatClient()
{
    ...
    App::Current->Suspending += ref new SuspendingEventHandler(this, &S1_ChatClient::App_Suspending);
}
...
/// <param name="e"></param>
void S1_ChatClient::App_Suspending(Object^ sender, Windows::ApplicationModel::SuspendingEventArgs^ e)
{
    Disconnect();
...
/// <param name="sender"></param>
/// <param name="e"></param>
void S1_ChatClient::RunButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
/// <param name="sender"></param>
/// <param name="e"></param>
void S1_ChatClient::ServiceList_Tapped(Platform::Object^ sender, Windows::UI::Xaml::Input::TappedRoutedEventArgs^ e)
{
...
/// <param name="sender"></param>
/// <param name="e"></param>
void S1_ChatClient::SendButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    try
    {
...
/// <param name="sender"></param>
/// <param name="e"></param>
void S1_ChatClient::DisconnectButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    Disconnect();
...
/// </summary>
void S1_ChatClient::ReceiveStringLoop(DataReader^ chatReader)
{
...
void S1_ChatClient::NotifyUserFromAsyncThread(String^ message, NotifyType type)
{
