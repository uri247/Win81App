...
MainPage::MainPage()
{
    ...
    AppBarControl->Text = FEATURE_NAME;
...
String^ MainPage::DetermineVisualState(double width)
{
...
void MainPage::InvalidateLayout()
{
    ...
    VisualStateManager::GoToState(InputSection, "Input" + DetermineVisualState(this->ActualWidth), false);
    VisualStateManager::GoToState(OutputSection, "Output" + DetermineVisualState(this->ActualWidth), false);
}
