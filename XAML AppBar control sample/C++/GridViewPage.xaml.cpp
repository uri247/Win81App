...
IceCream^ GridViewPage::GenerateItem()
{
	...
	case 1:
		...
		flavor->Image = "Assets/60Banana.png";
		break;
	case 2:
		flavor->Name = "Lavish Lemon Ice";
		flavor->Type = "Sorbet";
		flavor->Image = "Assets/60Lemon.png";
		break;
	case 3:
		flavor->Name = "Marvelous Mint";
		flavor->Type = "Gelato";
		flavor->Image = "Assets/60Mint.png";
		break;
	case 4:
		flavor->Name = "Creamy Orange";
		flavor->Type = "Sorbet";
		flavor->Image = "Assets/60Orange.png";
		break;
	case 5:
		flavor->Name = "Very Vanilla";
		flavor->Type = "Ice Cream";
		flavor->Image = "Assets/60Vanilla.png";
		break;
	default:
		flavor->Name = "Succulent Strawberry";
		flavor->Type = "Sorbet";
		flavor->Image = "Assets/60Strawberry.png";
	}
	return flavor;
}
