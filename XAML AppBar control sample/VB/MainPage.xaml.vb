...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class MainPage
        ...
        Public Sub New()
            ...
            AddHandler ScenariosList.SelectionChanged, AddressOf ScenariosList_SelectionChanged
        ...
        Private Sub InvalidateSize()
            ...
            If windowWidth <> 0.0 Then
                ...
                Dim listBoxWidth As Double = ScenariosList.ActualWidth

                ' Is the ListBox using any margins that we need to consider?
                Dim listBoxMarginLeft As Double = ScenariosList.Margin.Left
                Dim listBoxMarginRight As Double = ScenariosList.Margin.Right
        ...
        Private Function DetermineVisualState(ByVal width As Double) As String
        ...
        Private Sub PopulateScenarios()
            ...
            ScenariosList.ItemsSource = ScenarioList
            ...
            End If
            ScenariosList.SelectedIndex = If(startingScenarioIndex <> -1, startingScenarioIndex, 0)
            ScenariosList.ScrollIntoView(ScenariosList.SelectedItem)
        End Sub
        ...
        Private Sub ScenariosList_SelectionChanged(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
            If ScenariosList.SelectedItem IsNot Nothing Then
                NotifyUser("", NotifyType.StatusMessage)

                Dim selectedListBoxItem As ListBoxItem = TryCast(ScenariosList.SelectedItem, ListBoxItem)
                SuspensionManager.SessionState("SelectedScenarioIndex") = ScenariosList.SelectedIndex
