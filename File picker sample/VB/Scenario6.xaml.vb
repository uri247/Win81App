...
Partial Public NotInheritable Class Scenario6
    ...
    Private Async Sub WriteFileButton_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        If Not String.IsNullOrEmpty(fileToken) Then
            ...
            ' write to file
            Await FileIO.AppendTextAsync(file, String.Format("{0}Text Added @ {1}.", System.Environment.NewLine, Date.Now.ToString()))
