...
/// </summary>
task<void> Scenario2::CreateDefaultScannerObject(BarcodeScannerInstance instance)
{
...
void Scenario2::UpdateOutput(Platform::String^ strMessage)
{
...
/// </summary>
task<void> Scenario2::ClaimScanner(BarcodeScannerInstance instance)
{
	...
	case BarcodeScannerInstance::Instance1:
		...
		strInstance = "Instance1";
		break;
	case BarcodeScannerInstance::Instance2:
		scanner = this->scannerInstance2 ;
		strInstance = "Instance2";
		break;
	default:
		break;
	}
	...
	return create_task(scanner->ClaimScannerAsync()).then([this,instance, strInstance] (ClaimedBarcodeScanner^ claimedBarcodeScanner)
	{
		...
		{
			UpdateOutput(strInstance + " Claim Barcode Scanner succeeded.");
		}
		else
		{
			UpdateOutput(strInstance + " Claim Barcode Scanner failed.");  
		}
...
/// </summary>
task<void> Scenario2::EnableScanner(BarcodeScannerInstance instance)
{
	...
	return create_task(claimedBarcodeScanner->EnableAsync()).then([this,strInstance](void)
	{
		UpdateOutput(strInstance + " Enable Barcode Scanner succeeded.");
	});
...
/// </summary>
void Scenario2::SetUI(BarcodeScannerInstance instance)
{
...
void Scenario2::OnDataReceivedInstance1(Windows::Devices::PointOfService::ClaimedBarcodeScanner ^sender, Windows::Devices::PointOfService::BarcodeScannerDataReceivedEventArgs ^args)
{
...
/// <param name="sender"></param>
/// <param name="args"> Contains the BarcodeScannerReport which contains the data obtained in the scan</param>
void Scenario2::OnDataReceivedInstance2(Windows::Devices::PointOfService::ClaimedBarcodeScanner ^sender, Windows::Devices::PointOfService::BarcodeScannerDataReceivedEventArgs ^args)
{
	// read the data from the buffer and convert to string.
	Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(
		[this,args]()
...
void Scenario2::OnReleaseDeviceRequestedInstance1(Platform::Object ^sender, Windows::Devices::PointOfService::ClaimedBarcodeScanner ^args)
{
	Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(
		[this,args]()
	{
		UpdateOutput("\nReleaseDeviceRequested " + args->DeviceId);
		...
		else
		{
			...
			UpdateOutput("Instance1 Barcode Scanner released\n");
		}
	}));
}
...
/// <param name="sender"></param>
/// <param name="args"> Contains the ClamiedBarcodeScanner that is sending this request</param>
void Scenario2::OnReleaseDeviceRequestedInstance2(Platform::Object ^sender, Windows::Devices::PointOfService::ClaimedBarcodeScanner ^args)
{
	Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(
		[this,args]()
	{
		...
		else
		{
			...
			UpdateOutput("Instance2 Barcode Scanner released\n");
		}
	}));
}
...
/// <param name="sender"></param>
/// <param name="e"></param>
void Scenario2::ButtonStartScanningInstance1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
			...
			create_task(ClaimScanner(BarcodeScannerInstance::Instance1)).then([this](void)
			{
				if (claimedBarcodeScannerInstance1 != nullptr )
				{
					...
					create_task(EnableScanner(BarcodeScannerInstance::Instance1)).then([this](void)
					{
						...
						dataReceivedTokenInstance1 =  claimedBarcodeScannerInstance1->DataReceived::add(ref new TypedEventHandler<ClaimedBarcodeScanner^, BarcodeScannerDataReceivedEventArgs^>(this, &Scenario2::OnDataReceivedInstance1));
						releaseDeviceRequestedTokenInstance1 = claimedBarcodeScannerInstance1->ReleaseDeviceRequested::add(ref new EventHandler<ClaimedBarcodeScanner^>(this, &Scenario2::OnReleaseDeviceRequestedInstance1));

						UpdateOutput("Instance1 Attached the DataReceived Event handler.");
						UpdateOutput("Instance1 Ready to Scan.");
						Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(
							[this]()
						{
...
/// <param name="sender"></param>
/// <param name="e"></param>
void Scenario2::ButtonStartScanningInstance2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
			...
			create_task(ClaimScanner(BarcodeScannerInstance::Instance2)).then([this](void)
			{
				if (claimedBarcodeScannerInstance2 != nullptr )
				{
					...
					create_task(EnableScanner(BarcodeScannerInstance::Instance2)).then([this](void)
					{
						...
						dataReceivedTokenInstance2 =  claimedBarcodeScannerInstance2->DataReceived::add(ref new TypedEventHandler<ClaimedBarcodeScanner^, BarcodeScannerDataReceivedEventArgs^>(this, &Scenario2::OnDataReceivedInstance2));
						releaseDeviceRequestedTokenInstance2 = claimedBarcodeScannerInstance2->ReleaseDeviceRequested::add(ref new EventHandler<ClaimedBarcodeScanner^>(this, &Scenario2::OnReleaseDeviceRequestedInstance2));

						UpdateOutput("Instance2 Attached the DataReceived Event handler.");
						UpdateOutput("Instance2 Ready to Scan.");
						Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(
							[this]()
						{
...
/// <param name="sender"></param>
/// <param name="e"></param>
void Scenario2::ButtonEndScanningInstance1_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	// release the claimed scanner instance1
	if (claimedBarcodeScannerInstance1 != nullptr)
	{
...
/// <param name="sender"></param>
/// <param name="e"></param>
void Scenario2::ButtonEndScanningInstance2_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	if (claimedBarcodeScannerInstance2 != nullptr)
	{
		// release the claimed scanner instance1
