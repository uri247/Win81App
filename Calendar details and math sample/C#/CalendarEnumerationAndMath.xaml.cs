...
namespace CalendarSample
{
    ...
    /// </summary>
    public sealed partial class CalendarEnumerationAndMath : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private void Display_Click(object sender, RoutedEventArgs e)
        {
            ...
            Calendar currentCal = new Windows.Globalization.Calendar(new string[] { "en-US" }, CalendarIdentifiers.Gregorian, ClockIdentifiers.TwentyFourHour);
