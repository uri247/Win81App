...
void D2DInterpolationModes::HandlePointerPressed(PointerPoint^ point)
{
    ...
    if (position.Y > menuTop && position.Y < menuBottom)
    {
...
void D2DInterpolationModes::OnDpiChanged(_In_ DisplayInformation^ sender, _In_ Platform::Object^ args)
{
    SetDpi(sender->LogicalDpi);
    Render();
}

void D2DInterpolationModes::OnDisplayContentsInvalidated(_In_ DisplayInformation^ sender, _In_ Platform::Object^ args)
{
    ...
    )
{
    ...
    DisplayInformation::GetForCurrentView()->DpiChanged +=
        ref new TypedEventHandler<DisplayInformation^, Platform::Object^>(this, &D2DInterpolationModes::OnDpiChanged);

    DisplayInformation::DisplayContentsInvalidated +=
        ref new TypedEventHandler<DisplayInformation^, Platform::Object^>(this, &D2DInterpolationModes::OnDisplayContentsInvalidated);
