...
Partial Public NotInheritable Class Scenario10
    ...
    Private Sub SetCookie_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        Try
            Dim cookie As New HttpCookie(NameField.Text, DomainField.Text, PathField.Text)
            cookie.Value = ValueField.Text

            If NullCheckBox.IsChecked.Value Then
                cookie.Expires = Nothing
            Else
            ...
            Dim replaced As Boolean = filter.CookieManager.SetCookie(cookie, False)
