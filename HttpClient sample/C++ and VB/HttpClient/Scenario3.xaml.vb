...
Partial Public NotInheritable Class Scenario3
    ...
    Private Async Sub Start_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        Try
            ...
            Dim element As XElement = XElement.Parse(Await response.Content.ReadAsStringAsync().AsTask(cts.Token))
            OutputList.ItemsSource = ( _
                From c In element.Elements("item") _
