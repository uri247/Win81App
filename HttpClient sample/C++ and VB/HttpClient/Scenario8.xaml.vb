...
Partial Public NotInheritable Class Scenario8
    ...
    Private Async Sub Start_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        Try
            ...
            Dim jsonContent As IHttpContent = New HttpJsonContent(JsonValue.Parse("{""score"": 100, ""enabled"": false}"))

            Dim response As HttpResponseMessage = Await httpClient.PostAsync(resourceAddress, jsonContent).AsTask(cts.Token)
