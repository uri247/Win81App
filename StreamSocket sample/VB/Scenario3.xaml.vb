...
Partial Public NotInheritable Class Scenario3
    ...
    Private Async Sub SendHello_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        Dim socket As Sockets.StreamSocket
        If Not CoreApplication.Properties.TryGetValue("clientSocket", outValue) Then
            rootPage.NotifyUser("Please run previous steps before doing this one.", NotifyType.ErrorMessage)
            Return
        End If

        socket = CType(outValue, Sockets.StreamSocket)
        ...
        Else
            writer = CType(outValue, DataWriter)
        End If
