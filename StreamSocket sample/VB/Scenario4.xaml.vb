...
Partial Public NotInheritable Class Scenario4
    ...
    Private Sub CloseSockets_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        If CoreApplication.Properties.TryGetValue("clientDataWriter", outValue) Then
            ...
            Dim dataWriter As DataWriter = CType(outValue, DataWriter)
        ...
        If CoreApplication.Properties.TryGetValue("clientSocket", outValue) Then
            ...
            Dim socket As Sockets.StreamSocket = CType(outValue, Sockets.StreamSocket)
            socket.Dispose()
        End If
        ...
        If CoreApplication.Properties.TryGetValue("listener", outValue) Then
            ...
            Dim listener As StreamSocketListener = CType(outValue, StreamSocketListener)
            listener.Dispose()
        End If
