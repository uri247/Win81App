...
{
    InitializeComponent();
    this->Suspending += ref new SuspendingEventHandler(this, &DatagramSocketSample::App::OnSuspending);
}
...
void App::OnLaunched(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs^ pArgs)
{
    ...
    if (Window::Current->Content == nullptr)
    {
        ...
        TypeName pageType = { "DatagramSocketSample.MainPage", TypeKind::Custom };
