...
void App::DetermineAppTheme()
{
	//it will be Light by default.
	this->RequestedTheme = ApplicationTheme::Light;
	bool value = true;

	Windows::Storage::ApplicationDataContainer^ localSettings = Windows::Storage::ApplicationData::Current->LocalSettings;
	
    // check to see if there is a stored user setting
    if (localSettings->Values->HasKey("IsLightTheme"))
    {
        value = safe_cast<bool>(localSettings->Values->Lookup("IsLightTheme"));
    }
