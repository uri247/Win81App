...
DependencyProperty^ RichTextColumns::_richTextContentProperty = nullptr;
DependencyProperty^ RichTextColumns::_columnTemplateProperty = nullptr;

void RichTextColumns::RegisterDependencyProperties()
{
