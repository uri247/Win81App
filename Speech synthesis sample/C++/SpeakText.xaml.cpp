...
void VoiceSynthesisCPP::Scenario1::BtnSpeak_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    HRESULT hr = S_OK;
...
void VoiceSynthesisCPP::Scenario1::media_CurrentStateChanged(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
task<SpeechSynthesisStream ^> VoiceSynthesisCPP::Scenario1::GetSpeechStreamTask(String ^ text)
{
...
void VoiceSynthesisCPP::Scenario1::BtnSaveToFile_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    String^ text = this->tbData->Text;
...
void VoiceSynthesisCPP::Scenario1::ListboxVoiceChooser_SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
...
void VoiceSynthesisCPP::Scenario1::ListboxVoiceChooser_DoubleTapped(Platform::Object^ sender, Windows::UI::Xaml::Input::DoubleTappedRoutedEventArgs^ e)
{
    return this->ListboxVoiceChooser_SelectionChanged(sender, nullptr);
}

void VoiceSynthesisCPP::Scenario1::ListboxVoiceChooser_LoadVoices()
{
...
void VoiceSynthesisCPP::Scenario1::ShowFailureMessage(HRESULT hr)
{
