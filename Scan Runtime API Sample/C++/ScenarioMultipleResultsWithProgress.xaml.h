...
//
// ScenarioMultipleResultsWithProgress.xaml.h
// Declaration of the ScenarioMultipleResultsWithProgress class
//

#pragma once
#include "ScenarioMultipleResultsWithProgress.g.h"
...
namespace SDKSample
{
    namespace ScanRuntimeAPI
    {
        ...
        public ref class ScenarioMultipleResultsWithProgress sealed
        {
       public:
            ScenarioMultipleResultsWithProgress();
