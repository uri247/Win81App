...
Imports BackgroundTask.BackgroundTask

''' <summary>
''' An empty page that can be used on its own or navigated to within a Frame.
''' </summary>
Partial Public NotInheritable Class SampleBackgroundTaskWithCondition
    ...
    ''' <param name="e"></param>
    Private Sub RegisterBackgroundTask(ByVal sender As Object, ByVal e As RoutedEventArgs)
    ...
    Private Sub AttachProgressAndCompletedHandlers(ByVal task As IBackgroundTaskRegistration)
    ...
    Private Sub OnProgress(ByVal task As IBackgroundTaskRegistration, ByVal args As BackgroundTaskProgressEventArgs)
    ...
    Private Sub OnCompleted(ByVal task As IBackgroundTaskRegistration, ByVal args As BackgroundTaskCompletedEventArgs)
        UpdateUI()
    End Sub
