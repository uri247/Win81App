...
Partial Public NotInheritable Class Scenario3
    ...
    Private Async Sub NavigateToLink(ByVal sender As Object, ByVal e As RoutedEventArgs)
        Await Windows.System.Launcher.LaunchUriAsync(New Uri(SDKTemplate.MainPage.EXTENSION_SDK_LINK))
    End Sub

    Private Async Sub NavigateDPHelp(ByVal sender As Object, ByVal e As RoutedEventArgs)
