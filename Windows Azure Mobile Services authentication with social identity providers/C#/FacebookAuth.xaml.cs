...
namespace AzureMobileAuthentication
{
    ...
    /// </summary>
    public sealed partial class FacebookAuth
    {
        ...
        {
            FacebookOutputArea.Text = message;
        }

        /// <summary>
        /// Click handler of Facebook auth button
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private async void buttonFacebookAuth_Click(object sender, RoutedEventArgs e)
        {
            try
            {
