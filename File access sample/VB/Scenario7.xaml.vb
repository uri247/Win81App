...
Partial Public NotInheritable Class Scenario7
    ...
    Private Sub AddToListButton_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
    ...
    Private Sub ShowListButton_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        rootPage.ResetScenarioOutput(OutputTextBlock)
        Dim file As StorageFile = rootPage.sampleFile
        If file IsNot Nothing Then
            If MRURadioButton.IsChecked.Value Then
    ...
    Private Async Sub OpenFromListButton_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        rootPage.ResetScenarioOutput(OutputTextBlock)
