...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class MainPage
        ...
        Public ReadOnly Property LaunchArgs() As Windows.ApplicationModel.Activation.LaunchActivatedEventArgs
            Get
                Return CType(App.Current, App).LaunchArgs
            End Get
        End Property
        ...
        Private Sub InvalidateSize()
            ...
            If windowWidth <> 0.0 Then
                ...
                If Me.ActualWidth >= 768 Then
                    ...
                    OutputSection.Width = windowWidth - (layoutRootMarginLeft + layoutRootMarginRight)
                Else
