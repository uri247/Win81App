...
$iisAppName = "CCTHttpServerSample"
$iisAppPath = "$env:systemdrive\inetpub\wwwroot\CCTHttpServerSample"
$websitePath = "$scriptPath\website"
$firewallRuleName = "CCTHttpServerSample - HTTP 80"
...
$settingsFile = "$scriptPath\CCTHttpServerSampleScriptSettings"
