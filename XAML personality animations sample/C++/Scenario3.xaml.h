...
namespace SDKSample
{
	namespace PersonalityAnimations
	{
		...
		protected:
			...
			void Scenario3_ClickHandler1(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
			void Scenario3_ClickHandler2(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
