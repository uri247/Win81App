...
Partial Public NotInheritable Class ProximityDeviceScenario
    ...
    Private Sub ProximityDevice_PublishMessage(ByVal sender As Object, ByVal e As RoutedEventArgs)
        If _publishedMessageId = -1 Then
    ...
    Private Sub MessageReceived(ByVal proximityDevice As ProximityDevice, ByVal message As ProximityMessage)
        rootPage.UpdateLog("Message received: " & message.DataAsString, ProximityDeviceOutputText)
    End Sub

    Private Sub ProximityDevice_SubscribeForMessage(ByVal sender As Object, ByVal e As RoutedEventArgs)
        If _subscribedMessageId = -1 Then
