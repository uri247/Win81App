    ...
    SurfaceImageSource(pixelWidth, pixelHeight, isOpaque)
{
    ...
    Application::Current->Suspending += ref new SuspendingEventHandler(this, &Scenario1ImageSource::OnSuspending);
}
...
void Scenario1ImageSource::OnSuspending(Object ^sender, SuspendingEventArgs ^e)
{
