...
Partial Public NotInheritable Class Scenario1
    ...
    Public Sub New()
        ...
        Dim dataCategory As List(Of Expression.Blend.SampleData.SampleDataSource.GroupInfoList(Of Object)) = _storeData.GetGroupsByCategory()
...
#Region "Data Visualization"
    ...
    Private Sub ItemsByCategory_ContainerContentChanging(ByVal sender As ListViewBase, ByVal args As ContainerContentChangingEventArgs)
    ...
    Private ReadOnly Property ContainerContentChangingDelegate() As TypedEventHandler(Of ListViewBase, ContainerContentChangingEventArgs)
        Get
            If _delegate Is Nothing Then
                _delegate = New TypedEventHandler(Of ListViewBase, ContainerContentChangingEventArgs)(AddressOf ItemsByCategory_ContainerContentChanging)
            End If
            Return _delegate
        End Get
    End Property
