...
namespace SDKSample
{
    ...
    internal:
        property Windows::ApplicationModel::Activation::IContactActivatedEventArgs^ ContactEvent
        {
            Windows::ApplicationModel::Activation::IContactActivatedEventArgs^ get()
            {
                return contactEvent;
            }

            void set(Windows::ApplicationModel::Activation::IContactActivatedEventArgs^ value)
            {
                contactEvent = value;
            }
        }
        ...
        void NavigateToContactEventPage();
        void NavigateToProtocolEventPage();
    ...
    private:
        ...
        Windows::ApplicationModel::Activation::IContactActivatedEventArgs^ contactEvent;
        Windows::ApplicationModel::Activation::ProtocolActivatedEventArgs^ protocolEvent;
