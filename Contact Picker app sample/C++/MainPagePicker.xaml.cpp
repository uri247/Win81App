...
//
// MainPagePicker.xaml.cpp
// Implementation of the MainPagePicker.xaml class.
//
...
MainPagePicker^ MainPagePicker::Current = nullptr;

MainPagePicker::MainPagePicker()
{
    InitializeComponent();
    ...
    SetContactPicker(FEATURE_NAME);

    this->SizeChanged += ref new SizeChangedEventHandler(this, &MainPagePicker::MainPagePicker_SizeChanged);
    Scenarios->SelectionChanged += ref new SelectionChangedEventHandler(this, &MainPagePicker::Scenarios_SelectionChanged);

    MainPagePicker::Current = this;
}
...
void MainPagePicker::OnNavigatedTo(NavigationEventArgs^ e)
{
    PopulateScenarios();
    InvalidateLayout();
}
...
/// <param name="e"></param>
void MainPagePicker::MainPagePicker_SizeChanged(Object^ sender, SizeChangedEventArgs^ e)
{
    InvalidateSize();
    MainPagePickerSizeChangedEventArgs^ args = ref new MainPagePickerSizeChangedEventArgs();
    args->Width = this->ActualWidth;
    MainPagePickerResized(this, args);

}

void MainPagePicker::InvalidateSize()
{
...
void MainPagePicker::InvalidateLayout()
{
...
#pragma optimize("", off)
void MainPagePicker::PopulateScenarios()
{
...
void MainPagePicker::LoadScenario(String^ scenarioName)
{
...
void MainPagePicker::Scenarios_SelectionChanged(Object^ sender, SelectionChangedEventArgs^ e)
{
...
void MainPagePicker::SetContactPicker(String^ strFeature)
{
    ContactPicker->Text = strFeature;
}

void MainPagePicker::NotifyUser(String^ strMessage, NotifyType type)
{
    switch (type)
    {
...
void MainPagePicker::Footer_Click(Object^ sender, RoutedEventArgs^ e)
{
