...
Namespace Global.SDKTemplate
    ...
    ''' </summary>
    Partial Public NotInheritable Class MainPagePicker
        ...
        Public Shared Current As MainPagePicker
        ...
        Public Sub New()
            ...
            AddHandler SizeChanged, AddressOf MainPagePicker_SizeChanged

        End Sub

        Private Sub MainPagePicker_SizeChanged(ByVal sender As Object, ByVal e As SizeChangedEventArgs)
            InvalidateSize()
        End Sub
