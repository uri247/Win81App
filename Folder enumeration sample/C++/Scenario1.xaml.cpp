...
{
    InitializeComponent();
    GetFilesAndFolderButton->Click += ref new RoutedEventHandler(this, &Scenario1::GetFilesAndFolderButton_Click);
}

void Scenario1::GetFilesAndFolderButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
