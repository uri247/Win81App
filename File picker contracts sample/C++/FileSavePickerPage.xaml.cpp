...
//
// FileSavePickerPage.xaml.cpp
// Implementation of the FileSavePickerPage.xaml class.
//
...
FileSavePickerPage^ FileSavePickerPage::Current = nullptr;

FileSavePickerPage::FileSavePickerPage()
{
    InitializeComponent();
    ...
    this->SizeChanged += ref new SizeChangedEventHandler(this, &FileSavePickerPage::FileSavePickerPage_SizeChanged);
    Scenarios->SelectionChanged += ref new SelectionChangedEventHandler(this, &FileSavePickerPage::Scenarios_SelectionChanged);

    FileSavePickerPage::Current = this;
}
...
/// <param name="e"></param>
void FileSavePickerPage::FileSavePickerPage_SizeChanged(Object^ sender, SizeChangedEventArgs^ e)
{
    InvalidateSize();
...
void FileSavePickerPage::InvalidateSize()
{
...
void FileSavePickerPage::InvalidateLayout()
{
...
void FileSavePickerPage::PopulateScenarios()
{
...
void FileSavePickerPage::LoadScenario(String^ scenarioName)
{
...
void FileSavePickerPage::Scenarios_SelectionChanged(Object^ sender, SelectionChangedEventArgs^ e)
{
...
void FileSavePickerPage::NotifyUser(String^ strMessage, NotifyType type)
{
    switch (type)
    {
...
void FileSavePickerPage::Footer_Click(Object^ sender, RoutedEventArgs^ e)
{
...
void FileSavePickerPage::LoadState(Object^ navigationParameter, IMap<String^, Object^>^ pageState)
{
...
void FileSavePickerPage::SaveState(IMap<String^, Object^>^ pageState)
{
    int selectedListBoxItemIndex = Scenarios->SelectedIndex;
    pageState->Insert("SelectedScenarioIndex", selectedListBoxItemIndex);
}

void FileSavePickerPage::Activate(FileSavePickerActivatedEventArgs^ args)
{
    // cache FileSavePickerUI
