...
// Implementation of the FileOpenPickerPage.xaml class.
//
...
FileOpenPickerPage^ FileOpenPickerPage::Current = nullptr;
...
FileOpenPickerPage::FileOpenPickerPage()
{
    ...
    this->SizeChanged += ref new SizeChangedEventHandler(this, &FileOpenPickerPage::FileOpenPickerPage_SizeChanged);
    Scenarios->SelectionChanged += ref new SelectionChangedEventHandler(this, &FileOpenPickerPage::Scenarios_SelectionChanged);

    FileOpenPickerPage::Current = this;
}
...
/// <param name="e"></param>
void FileOpenPickerPage::FileOpenPickerPage_SizeChanged(Object^ sender, SizeChangedEventArgs^ e)
{
    InvalidateSize();
...
void FileOpenPickerPage::InvalidateSize()
{
...
void FileOpenPickerPage::InvalidateLayout()
{
...
void FileOpenPickerPage::PopulateScenarios()
{
...
void FileOpenPickerPage::LoadScenario(String^ scenarioName)
{
...
void FileOpenPickerPage::Scenarios_SelectionChanged(Object^ sender, SelectionChangedEventArgs^ e)
{
...
void FileOpenPickerPage::NotifyUser(String^ strMessage, NotifyType type)
{
    switch (type)
    {
...
void FileOpenPickerPage::Footer_Click(Object^ sender, RoutedEventArgs^ e)
{
...
void FileOpenPickerPage::LoadState(Object^ navigationParameter, IMap<String^, Object^>^ pageState)
{
...
void FileOpenPickerPage::SaveState(IMap<String^, Object^>^ pageState)
{
