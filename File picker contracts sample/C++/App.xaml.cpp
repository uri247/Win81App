...
void App::OnFileOpenPickerActivated(FileOpenPickerActivatedEventArgs^ args)
{
    auto fileOpenPickerPage = ref new FileOpenPickerPage();
    fileOpenPickerPage->Activate(args);
}

void App::OnFileSavePickerActivated(FileSavePickerActivatedEventArgs^ args)
{
    auto fileSavePickerPage = ref new FileSavePickerPage();
    fileSavePickerPage->Activate(args);
}

void App::OnCachedFileUpdaterActivated(CachedFileUpdaterActivatedEventArgs^ args)
{
    auto cachedFileUpdaterPage = ref new CachedFileUpdaterPage();
