...
Namespace Global.SDKTemplate
    ...
    Public NotInheritable Partial Class MainPage
        ...
        Public Const FEATURE_NAME As String = "File picker contracts VB sample"
        ...
        Private scenariosList As New List(Of Scenario)() From { _
            New Scenario() With {.Title = "File Open Picker contract", .ClassType = GetType(FilePickerContracts.MainPage_PickFile)}, _
            New Scenario() With {.Title = "File Save Picker contract", .ClassType = GetType(FilePickerContracts.MainPage_SaveFile)}, _
            New Scenario() With {.Title = "Cached File Updater contract", .ClassType = GetType(FilePickerContracts.MainPage_CachedFile)} _
        }
