...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class FileSavePickerPage
        ...
        Private scenariosList As New List(Of Scenario)() From { _
            New Scenario() With {.Title = "Save a file to app's storage", .ClassType = GetType(FilePickerContracts.FileSavePicker_SaveToAppStorage)}, _
            New Scenario() With {.Title = "Fail to save a file", .ClassType = GetType(FilePickerContracts.FileSavePicker_FailToSave)}, _
            New Scenario() With {.Title = "Save to cached file", .ClassType = GetType(FilePickerContracts.FileSavePicker_SaveToCachedFile)} _
        }
        ...
        Private Sub FileSavePickerPage_SizeChanged(ByVal sender As Object, ByVal e As SizeChangedEventArgs)
            InvalidateSize()
            If FileSavePickerPageResizedEvent IsNot Nothing Then
