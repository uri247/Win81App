...
namespace SDKTemplate
{
    ...
    public sealed partial class MainPage : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        private void PopulateScenarios()
        {
            ...
            {
                int selectedScenarioIndex = Convert.ToInt32(SuspensionManager.SessionState["SelectedScenarioIndex"], CultureInfo.InvariantCulture);
        ...
        public void LoadScenarioForProtocolActivation(ProtocolActivatedEventArgs protocolArgs)
        {
            ...
            {
                if (protocolArgs.Uri.Equals(scenario.ApplicationLink))
                {
                    // By setting the selected index, the Scenarios_SelectionChanged(...) method will be called
                    Scenarios.SelectedIndex = scenarios.IndexOf(scenario);
                    break;
                }
            }
        }
