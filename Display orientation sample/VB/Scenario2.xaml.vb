...
Partial Public NotInheritable Class Scenario2
    ...
    Protected Overrides Sub OnNavigatedTo(ByVal e As NavigationEventArgs)
        ...
        If DisplayInformation.AutoRotationPreferences = DisplayOrientations.None Then
    ...
    Private Sub Scenario2Button_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        If DisplayInformation.AutoRotationPreferences = DisplayOrientations.None Then
